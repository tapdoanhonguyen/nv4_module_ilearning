...
{
    global $global_config, $lang_global, $lang_module, $module_name, $module_file, $module_info, $my_head,$db;
    ...
    $xtpl->assign('ROW', $row);
    if($row['folder']){
        $xtpl->assign('LINK_BAI_GIANG', NV_BASE_SITEURL . NV_UPLOADS_DIR . '/' . $module_name . '/' . $row['folder']);
