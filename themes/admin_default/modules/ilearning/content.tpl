...
<form action="{FORM_ACTION}" method="post" class="confirm-reload" id="file-upload-form" data-busy="false" enctype="multipart/form-data" >
    <div class="row">
                ...
                <table class="table table-striped table-bordered table-hover">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="display: flex;">
                             <a href="{LINK_BAI_GIANG}" title=" Xem bài giảng" class="btn btn-primary">
                                 Xem bài giảng
                             </a>
                         </td>
                     </tr>
                    ...
                    <tr>
                        <td> {LANG.category_cat_parent}123 <sup class="required">(*)</sup></td>
                        <td>
